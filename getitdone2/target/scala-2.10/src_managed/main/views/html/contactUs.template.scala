...
import views.html._
/**/
object contactUs extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template5[String,String,String,Integer,String,play.api.templates.HtmlFormat.Appendable] {
				...
				<fieldset>
					<h2 style="color:gray;">
        			 ...
        			 <h3 style="text-align:left;">
       				 	Contact us about Getitdone.com. Leave us a message.
        			</h3>
					<p style="color:blue;">
						 Getitdone&#64;tum.de
					</p>
        ...
        <footer>
            ...
            <div id="wrap">
                ...
                <div class="right">
                    ...
                    <IMG SRC=""""),_display_(Seq[Any](/*93.32*/routes/*93.38*/.Assets.at("images/soft-logo.png"))),format.raw/*93.72*/("""" vspace="70px" align="center" HEIGHT=30px>
                </div>
                <div class="clearBoth">
                </div>
            </div>
